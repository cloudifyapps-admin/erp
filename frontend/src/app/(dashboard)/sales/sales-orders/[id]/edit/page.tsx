...
export default function EditSalesOrderPage() {
  ...
  const setSelectField = (key: keyof OrderForm) => (value: string) =>
          ...
          <Tabs defaultValue="details" className="gap-0">
            ...
            <TabsContent value="details" className="p-6 lg:px-8 lg:py-2">
              <FormRow label="Order Number">
                <Input id="order_number" value={form.order_number} onChange={setField('order_number')} placeholder="SO-0001" className="h-10" />
              </FormRow>
              ...
              <FormRow label="Order Date">
                <Input id="order_date" type="date" value={form.order_date} onChange={setField('order_date')} className="h-10" />
              </FormRow>
            ...
            <TabsContent value="notes" className="p-6 lg:px-8 lg:py-6">
              <div className="flex flex-col gap-2">
                ...
                <Textarea value={form.notes} onChange={setField('notes')} placeholder="Add any notes for this order..." rows={8} className="resize-none" />
              </div>
            </TabsContent>
          </Tabs>
        </div>
