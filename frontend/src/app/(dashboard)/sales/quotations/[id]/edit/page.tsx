          ...
          <Tabs defaultValue="details" className="gap-0">
            <div className="border-b border-border/40 bg-muted/30 px-6">
              <TabsList variant="line" className="!h-auto gap-2">
                ...
                <TabsTrigger value="terms-notes" className="gap-2.5 px-5 py-3.5 text-[14px] cursor-pointer data-active:font-semibold">
            ...
            <TabsContent value="details" className="p-6 lg:px-8 lg:py-2">
              <FormRow label="Quotation Number">
                <Input id="number" value={form.number} onChange={setField('number')} placeholder="QUO-0001" className="h-10" />
              </FormRow>
              ...
              <FormRow label="Valid Until">
                <Input id="valid_until" type="date" value={form.valid_until} onChange={setField('valid_until')} className="h-10" />
              </FormRow>
              ...
              <FormRow label="Delivery Terms">
                <Input id="delivery_terms" value={form.delivery_terms} onChange={setField('delivery_terms')} placeholder="e.g. FOB, CIF, EXW" className="h-10" />
              </FormRow>
            </TabsContent>
            ...
            <TabsContent value="terms-notes" className="p-6 lg:px-8 lg:py-6">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-2">
                  <p className="text-[12px] font-semibold uppercase tracking-wider text-muted-foreground/70">Notes</p>
                  <Textarea value={form.notes} onChange={setField('notes')} placeholder="Notes visible to the customer..." rows={5} className="resize-none" />
                </div>
                <div className="flex flex-col gap-2">
                  <p className="text-[12px] font-semibold uppercase tracking-wider text-muted-foreground/70">Terms & Conditions</p>
                  <Textarea value={form.terms_and_conditions} onChange={setField('terms_and_conditions')} placeholder="Terms and conditions..." rows={5} className="resize-none" />
                </div>
              </div>
            </TabsContent>
          </Tabs>
