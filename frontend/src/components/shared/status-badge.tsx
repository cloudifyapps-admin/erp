...
function getStatusColor(status: string): string {
  ...
  const colorMap: Record<string, string> = {
    ...
    nurturing: 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300',
    // green
    ...
    unqualified: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300',
